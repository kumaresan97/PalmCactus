...
export default class DisclosedInvestorsWebPart extends BaseClientSideWebPart<IDisclosedInvestorsWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IDisclosedInvestorsProps> =
      React.createElement(DisclosedInvestors, {
